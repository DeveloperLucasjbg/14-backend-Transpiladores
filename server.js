...
var express = __importStar(require(".node_modules/express"));
var metodos = __importStar(require("./metodos"));
var handlebars = __importStar(require("express-handlebars"));
var urlencoded = __importStar(require("express"));
var app = express();
var PORT = 4545;
...
router.get("/productos/vista", function (_, res) {
    res.render("main", {
